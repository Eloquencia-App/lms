...
<div id="sidebar" class="sidebar d-flex flex-column">
    ...
    <nav class="nav flex-column">
        <a href="#" class="nav-link active"><i class="fas fa-house"></i><span>Accueil</span></a>
    </nav>
    <hr>
    <nav class="nav flex-column">
        <a href="#" class="nav-link"><i class="fas fa-book"></i><span>Chapitre 1</span></a>
    </nav>
    <div class="dropup mt-auto mb-3">
        <button type="button" class="btn btn-secondary dropdown-toggle w-100 text-start text-truncate show" data-bs-toggle="dropdown" aria-expanded="false">
            Nom Prénom
        </button>
